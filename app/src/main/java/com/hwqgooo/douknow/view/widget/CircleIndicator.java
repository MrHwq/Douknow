...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        if (mAnimatorResId == 0) {
            mAnimatorResId = R.animator.scale_with_alpha;
        }
    ...
    public static void setViewPager(final CircleIndicator indicator, ViewPager viewPager) {
        Log.d("hwqhwq", "setViewPager: " + viewPager);
        if (viewPager == null) {
            return;
        }
    ...
    public static void setIndicatorCount(final CircleIndicator indicator, int count) {
        Log.d("hwqhwq", "setIndicatorCount: " + count);
        indicator.setIndicatorCount(count);
    }
    ...
    private void createIndicators(int count) {
        if (count == 0 || this.indicatorCount == count) {
            return;
        }
        removeAllViews();
